    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item \checkmark \textbf{Protocol}: (mandatory) The network has some \textbf{Other Protocols} - half-duplex to interact with the various infrared distance sensors and laser scanners, whereas a full duplex protocol to interact with the administrator, and the different actuators.
            \end{itemize}
        \end{itemize}
        \item \checkmark \textbf{Physical}: (mandatory) The physical elements of the robot.
        \begin{itemize}
            \item \checkmark \textbf{Sensor}: (mandatory) Various sensors which provide feedback to the controller, like the infrared distance sensors, laser scanners, the incremental encoder from the drive unit of the actuators, the sensors comprising the indoor GPS-like navigation system, the communication antennae for communicating with the administrator, etc.  
            \item \checkmark \textbf{Actuator}: (mandatory) The servo motors, omni-directional drive system, gripper, etc.
            \item \checkmark \textbf{Plant}: (mandatory) The robot.
            \item \checkmark \textbf{Controller}: (mandatory)
            \begin{itemize}
            ...
            \end{itemize}
            \item \checkmark \textbf{Environment}: (mandatory) The HPI CPSLab environment where the robot operates.
        \end{itemize}
    \end{itemize}
    \item \checkmark \textbf{nonfunctionalReqs} : \textbf{Performance}, \textbf{Security}, \textbf{Safety}, \textbf{Reliability}, \textbf{Efficiency}, \textbf{Scalability}, \textbf{Composability}, \textbf{Availability}, \textbf{Sustainability}, \textbf{Others}
    \item \checkmark \textbf{ApplicationDomain} : Domain of application of the robot can be broadly put under \textbf{RoboticforService} i.e. Service Robot.
    \item \checkmark \textbf{Disciplines} : The disciplines associated with the robot are - \textbf{Software Engineering}, \textbf{Mechanical Engineering}, \textbf{Electrical Engineering} 
\end{itemize}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.3]{figures/mm-hpi4.pdf}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.3]{figures/CPSLabMilMMF.jpg}
