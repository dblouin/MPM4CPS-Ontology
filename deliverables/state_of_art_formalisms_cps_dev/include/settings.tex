...
% DB: Command for todos
\newcommand{\todoAuthors}[1]{\textbf{TODO Author(s): #1}}
\newcommand{\cpsUsage}[1]{\textbf{#1}}
\newcommand{\beginCpsUsage}[1]{\begin{#1}}
\newcommand{\itemCpsUsage}{\item}
\newcommand{\bibentryCpsUsage}[1]{\bibentry{#1}}
\newcommand{\bendCpsUsage}[1]{\end{#1}}

%\newcommand{\todoAuthors}[1]{}
%\newcommand{\cpsUsage}[1]{}
%\newcommand{\beginCpsUsage}[1]{}
%\newcommand{\itemCpsUsage}{}
%\newcommand{\bibentryCpsUsage}[1]{}
%\newcommand{\bendCpsUsage}[1]{}
